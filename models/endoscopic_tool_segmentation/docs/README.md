...
The default dataset path is defined as "/workspace/data/endoscopic_tool_dataset" in "configs/train.json", please modify it to the actual path via modifying `dataset_dir`:
